...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm("service_489rxes", "template_g3vplip", form.current, "OG36Abt694hIfeU0B")
      .then((result) => {
        ...
        <div className="contact__content">
            ...
            <div className="contct__info">
                <div className="contact__card">
                    ...
                    <span className="contact__card-data">user@gmail.com
                    </span>
                ...
                <div className="contact__card">
                    ...
                    <span className="contact__card-data">999-999-9998</span>
